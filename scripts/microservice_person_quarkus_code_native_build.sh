...
NC='\033[0m' # No Color
    ...
    CONTAINER_IMAGE="my-registry/my-project/microservice-person-quarkus-native:$VERSION"
...
echo "${GREEN}##########################################################################################${NC}\n"
    ...
    echo "Example run command: ${BLUE}docker run -p 8084:8080 -e \"QUARKUS_PROFILE=db-in-memory\" $CONTAINER_IMAGE${NC}"
